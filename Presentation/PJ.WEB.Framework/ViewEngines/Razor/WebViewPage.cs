...
using JFP.WEB.Framework.Localization;
using JFP.Services.Textos;
#endregion

namespace JFP.WEB.Framework.ViewEngines.Razor
{
       ...
       // private ITextoServices _localizationService;
            ...
            get
            {
                if (_localizer == null)
                {
                    ...
                    _localizer = (format, args) =>
                                     {
                                         var resFormat = ""; //_localizationService.GetText(format);
        ...
        public override void InitHelpers()
        {
            base.InitHelpers();
                ...
                //_localizationService = EngineContext.Current.Resolve<ITextoServices>();
