(function () {
    ...
    .controller("busquedasController", ["$scope", "busquedasFactory", function ($scope, busquedasFactory) {
        ...
        var doSearch = function (nombreUso) {
            ...
            if (!!nombreUso) {
                callRegistrarUso("AplicarFiltroResultado", ["MetaData", "[Origen:ResultadosBusquedas]" + nombreUso]);
            }
