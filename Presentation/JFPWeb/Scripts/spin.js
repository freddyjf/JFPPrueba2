        ...
        $.fn.spin = function (overlayStyleOptions, spinnerStyleOptions) {
            ...
            this.each(function () {
                ...
                if (spinning === true) {
                    ...
                    overlayStyles.height = (this === window) ? $(document).innerHeight() + "px" : height + "px";
...
(function () {
    ...
    Spin.prototype.start = function (configSpin, overlayStyleOptions, spinnerStyleOptions) {
        if ($(document).isSpinning())
            this.stop();

        configSpin = configSpin || {};
        overlayStyleOptions = overlayStyleOptions || {};
        spinnerStyleOptions = spinnerStyleOptions || {};

        var spinner = new Spinner(configSpin).spin();
        var _spinnerStyleOptions = $.extend(spinnerStyleOptions, { backgroundImage: "" });

        $(window).spin(overlayStyleOptions, _spinnerStyleOptions);

        $(".js-spin-spinner").append(spinner.el);
    };
