...
.directive('uibDatepicker', function () {
    return {
        ...
        templateUrl: function (element, attrs) {
            return attrs.templateUrl || '/Scripts/angular-ui/template/datepicker/datepicker.html';
        },
        scope: {
            datepickerMode: '=?',
            datepickerOptions: '=?',
...
.directive('uibDaypicker', function () {
    return {
        replace: true,
        templateUrl: function (element, attrs) {
            return attrs.templateUrl || '/Scripts/angular-ui/template/datepicker/day.html';
        },
...
.directive('uibMonthpicker', function () {
    return {
        replace: true,
        templateUrl: function (element, attrs) {
            return attrs.templateUrl || '/Scripts/angular-ui/template/datepicker/month.html';
        },
...
.directive('uibYearpicker', function () {
    return {
        replace: true,
        templateUrl: function (element, attrs) {
            return attrs.templateUrl || '/Scripts/angular-ui/template/datepicker/year.html';
        },
...
.constant('uibDatepickerPopupConfig', {
    ...
    datepickerPopupTemplateUrl: '/Scripts/angular-ui/template/datepicker/popup.html',
    datepickerTemplateUrl: '/Scripts/angular-ui/template/datepicker/datepicker.html',
    html5Types: {
        date: 'yyyy-MM-dd',
...
.directive('uibDatepickerPopupWrap', function () {
    return {
        ...
        transclude: true,
        templateUrl: function (element, attrs) {
            return attrs.templateUrl || '/Scripts/angular-ui/template/datepicker/popup.html';
        }
    };
});
...
.directive('uibPagination', ['$parse', 'uibPaginationConfig', function ($parse, uibPaginationConfig) {
    return {
        ...
        templateUrl: function (element, attrs) {
            return attrs.templateUrl || '/Scripts/angular-ui/template/pagination/pagination.html';
        },
        replace: true,
        link: function (scope, element, attrs, ctrls) {
